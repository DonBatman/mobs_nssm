...
-- SPIDERS
mobs:spawn_specific("nssm:tarantula", {"default:jungle_grass", "nssm:web" }, {"air"},
	0, 14, 120, 5000, 3, -31000, 31000)
mobs:spawn_specific("nssm:uloboros", {"default:jungle_grass", "nssm:web" }, {"air"},
	0, 20, 20, 1000, 3, -31000, 31000)

-- SEA
mobs:spawn_specific("nssm:crocodile", {"default:sand","default:water_source"}, {"air"},
	0, 20, 60, 35000, 2, -31000, 31000)
